# Instructions and Guidelines for Project 1
...
> Our project is to uncover patterns in criminal activity around Washington, DC. We'll examine relationships between types of crime and location; crime rates and times of day; trends in crime rates over the course of the year; and related questions, as the data admits.
...
Finally, be sure that your projects meet the [technical requirements](02-Technical-Requirements.md).
...
As long as your slides meet the [presentation requirements](03-Presentation-Requirements.md), you are free to structure the presentation however you wish, but students are often successful with the format laid out in the [presentation guidelines](04-Presentation-Guidelines.md).
